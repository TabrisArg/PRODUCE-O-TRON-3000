    ...
    <div className="p-4 space-y-6 font-serif text-black">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-grow space-y-2">
                ...
                {resources.map((res) => (
                  <tr key={res.id} className="border-b border-gray-300 hover:bg-blue-50">
                    ...
                    <td className="p-1 text-center space-x-1">
                      {res.isOverride && (
                        <button onClick={() => resetOverride(res.id)} className="text-[10px] text-gray-500 hover:text-black">
                          <img src={ICONS.RECALCULATE} alt="reset" className="w-3 h-3 inline-block" />
                        </button>
                      )}
                      <button onClick={() => removeResource(res.id)} className="text-red-700 font-bold hover:bg-red-100 px-2">
                        <img src={ICONS.CLOSE} alt="remove" className="w-3 h-3 inline-block" />
                      </button>
                    </td>
                  </tr>
                ))}
          ...
          <RetroButton onClick={addResource} className="mt-2 text-xs font-bold text-black flex items-center gap-1">
            <img src={ICONS.SUGGEST} alt="add" className="w-3 h-3" />
            Add Resource
          </RetroButton>
        </div>
        ...
        <div className="w-full lg:w-96 shrink-0">
          <div className="win95-bg p-4 retro-beveled space-y-4 border-2 border-gray-400 h-full">
            ...
            <div className="pt-2">
              <RetroButton className="w-full text-xs font-bold text-black flex items-center justify-center gap-2" onClick={handleGenerateExcel}>
